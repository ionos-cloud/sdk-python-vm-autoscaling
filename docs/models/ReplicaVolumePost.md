...
**bus** | [**BusType**](BusType.md) |  | [optional] [default to BusType.VIRTIO]
...
replica_volume_post_instance = ReplicaVolumePost.from_json(json)
# print the JSON string representation of the object
print(ReplicaVolumePost.to_json())

# convert the object into a dict
replica_volume_post_dict = replica_volume_post_instance.to_dict()
# create an instance of ReplicaVolumePost from a dict
replica_volume_post_from_dict = ReplicaVolumePost.from_dict(replica_volume_post_dict)
```
