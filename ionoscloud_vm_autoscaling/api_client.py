...
from ionoscloud_vm_autoscaling.api_response import ApiResponse, T as ApiResponseT
import ionoscloud_vm_autoscaling.models
from ionoscloud_vm_autoscaling import rest
from ionoscloud_vm_autoscaling.exceptions import (
    ApiValueError,
    ApiException,
    ApiFailedRequest,
    ApiTimeout,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'ionos-cloud-sdk-python/v2.0.0'
