...
class TerminationPolicyType(object):
    ...
    allowable_values = [OLDEST_SERVER_FIRST, NEWEST_SERVER_FIRST, RANDOM]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """TerminationPolicyType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TerminationPolicyType):
            return False
