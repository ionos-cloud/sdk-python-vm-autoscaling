...
class ErrorAuthorize(BaseModel):
    """
    ErrorAuthorize
    """ # noqa: E501
    http_status: Optional[StrictInt] = Field(default=None, alias="httpStatus")
    messages: Optional[List[ErrorAuthorizeMessage]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [ErrorAuthorizeMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
