...
class GroupProperties(object):
    ...
    def __init__(self, max_replica_count=None, min_replica_count=None, target_replica_count=None, name=None, policy=None, replica_configuration=None, datacenter=None, location=None, local_vars_configuration=None):  # noqa: E501
