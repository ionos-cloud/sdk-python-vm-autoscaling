...
class GroupPostEntities(BaseModel):
    """
    The entities associated with this resource. The content depends on the resource type.
    """ # noqa: E501
    actions: Optional[ActionsLinkResource] = None
    servers: Optional[ServersLinkResource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": ActionsLinkResource.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "servers": ServersLinkResource.from_dict(obj["servers"]) if obj.get("servers") is not None else None
        })
        return _obj
