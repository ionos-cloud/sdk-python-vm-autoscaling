...
class NicFirewallRule(object):
    ...
    def __init__(self, name=None, protocol=None, source_mac=None, source_ip=None, target_ip=None, icmp_code=None, icmp_type=None, port_range_start=None, port_range_end=None, type=None, local_vars_configuration=None):  # noqa: E501
        """NicFirewallRule - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this NicFirewallRule.  # noqa: E501

        The name of the firewall rule.  # noqa: E501

        :return: The name of this NicFirewallRule.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NicFirewallRule.

        The name of the firewall rule.  # noqa: E501

        :param name: The name of this NicFirewallRule.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def protocol(self):
        """Gets the protocol of this NicFirewallRule.  # noqa: E501

        The protocol for the rule. The property cannot be modified after its creation (not allowed in update requests).  # noqa: E501

        :return: The protocol of this NicFirewallRule.  # noqa: E501
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this NicFirewallRule.

        The protocol for the rule. The property cannot be modified after its creation (not allowed in update requests).  # noqa: E501

        :param protocol: The protocol of this NicFirewallRule.  # noqa: E501
        :type protocol: str
        """
    ...
    @property
    def source_mac(self):
        """Gets the source_mac of this NicFirewallRule.  # noqa: E501

        Only traffic originating from the respective MAC address is permitted. Valid format: 'aa:bb:cc:dd:ee:ff'. The value 'null' allows traffic from any MAC address.  # noqa: E501

        :return: The source_mac of this NicFirewallRule.  # noqa: E501
        :rtype: str
        """
    ...
    def source_mac(self, source_mac):
        """Sets the source_mac of this NicFirewallRule.

        Only traffic originating from the respective MAC address is permitted. Valid format: 'aa:bb:cc:dd:ee:ff'. The value 'null' allows traffic from any MAC address.  # noqa: E501

        :param source_mac: The source_mac of this NicFirewallRule.  # noqa: E501
        :type source_mac: str
        """
    ...
    @property
    def source_ip(self):
        """Gets the source_ip of this NicFirewallRule.  # noqa: E501

        Only traffic originating from the respective IPv4 address is permitted. The value 'null' allows traffic from any IP address.  # noqa: E501

        :return: The source_ip of this NicFirewallRule.  # noqa: E501
        :rtype: str
        """
    ...
    def source_ip(self, source_ip):
        """Sets the source_ip of this NicFirewallRule.

        Only traffic originating from the respective IPv4 address is permitted. The value 'null' allows traffic from any IP address.  # noqa: E501

        :param source_ip: The source_ip of this NicFirewallRule.  # noqa: E501
        :type source_ip: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def target_ip(self):
        """Gets the target_ip of this NicFirewallRule.  # noqa: E501

        If the target NIC has multiple IP addresses, only the traffic directed to the respective IP address of the NIC is allowed. The value 'null' allows traffic to any target IP address.  # noqa: E501

        :return: The target_ip of this NicFirewallRule.  # noqa: E501
        :rtype: str
        """
    ...
    def target_ip(self, target_ip):
        """Sets the target_ip of this NicFirewallRule.

        If the target NIC has multiple IP addresses, only the traffic directed to the respective IP address of the NIC is allowed. The value 'null' allows traffic to any target IP address.  # noqa: E501

        :param target_ip: The target_ip of this NicFirewallRule.  # noqa: E501
        :type target_ip: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def icmp_code(self):
        """Gets the icmp_code of this NicFirewallRule.  # noqa: E501

        Sets the allowed code (from 0 to 254) when ICMP protocol is selected. The value 'null'' allows all codes.  # noqa: E501

        :return: The icmp_code of this NicFirewallRule.  # noqa: E501
        :rtype: int
        """
    ...
    def icmp_code(self, icmp_code):
        """Sets the icmp_code of this NicFirewallRule.

        Sets the allowed code (from 0 to 254) when ICMP protocol is selected. The value 'null'' allows all codes.  # noqa: E501

        :param icmp_code: The icmp_code of this NicFirewallRule.  # noqa: E501
        :type icmp_code: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def icmp_type(self):
        """Gets the icmp_type of this NicFirewallRule.  # noqa: E501

        Sets the allowed type (from 0 to 254) if the protocol ICMP is selected. The value 'null' allows all types.  # noqa: E501

        :return: The icmp_type of this NicFirewallRule.  # noqa: E501
        :rtype: int
        """
    ...
    def icmp_type(self, icmp_type):
        """Sets the icmp_type of this NicFirewallRule.

        Sets the allowed type (from 0 to 254) if the protocol ICMP is selected. The value 'null' allows all types.  # noqa: E501

        :param icmp_type: The icmp_type of this NicFirewallRule.  # noqa: E501
        :type icmp_type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def type(self):
        """Gets the type of this NicFirewallRule.  # noqa: E501

        The firewall rule type. If not specified, the default value 'INGRESS' is used.  # noqa: E501

        :return: The type of this NicFirewallRule.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this NicFirewallRule.

        The firewall rule type. If not specified, the default value 'INGRESS' is used.  # noqa: E501

        :param type: The type of this NicFirewallRule.  # noqa: E501
        :type type: str
        """
        allowed_values = [None,"INGRESS", "EGRESS"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NicFirewallRule):
            return False
