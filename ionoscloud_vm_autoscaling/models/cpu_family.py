...
class CpuFamily(object):
    ...
    allowable_values = [AMD_OPTERON, INTEL_SKYLAKE, INTEL_XEON]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CpuFamily - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CpuFamily):
            return False
