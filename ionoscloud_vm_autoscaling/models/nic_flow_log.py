...
class NicFlowLog(object):
    ...
    def __init__(self, name=None, action=None, direction=None, bucket=None, local_vars_configuration=None):  # noqa: E501
        """NicFlowLog - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this NicFlowLog.  # noqa: E501

        The flow log name.  # noqa: E501

        :return: The name of this NicFlowLog.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NicFlowLog.

        The flow log name.  # noqa: E501

        :param name: The name of this NicFlowLog.  # noqa: E501
        :type name: str
        """
    ...
    @property
    def action(self):
        """Gets the action of this NicFlowLog.  # noqa: E501

        Specifies the traffic action pattern.  # noqa: E501

        :return: The action of this NicFlowLog.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this NicFlowLog.

        Specifies the traffic action pattern.  # noqa: E501

        :param action: The action of this NicFlowLog.  # noqa: E501
        :type action: str
        """
    ...
    @property
    def direction(self):
        """Gets the direction of this NicFlowLog.  # noqa: E501

        Specifies the traffic direction pattern.  # noqa: E501

        :return: The direction of this NicFlowLog.  # noqa: E501
        :rtype: str
        """
    ...
    def direction(self, direction):
        """Sets the direction of this NicFlowLog.

        Specifies the traffic direction pattern.  # noqa: E501

        :param direction: The direction of this NicFlowLog.  # noqa: E501
        :type direction: str
        """
    ...
    @property
    def bucket(self):
        """Gets the bucket of this NicFlowLog.  # noqa: E501

        The S3 bucket name of an existing IONOS Cloud S3 bucket.  # noqa: E501

        :return: The bucket of this NicFlowLog.  # noqa: E501
        :rtype: str
        """
        return self._bucket
    ...
    def bucket(self, bucket):
        """Sets the bucket of this NicFlowLog.

        The S3 bucket name of an existing IONOS Cloud S3 bucket.  # noqa: E501

        :param bucket: The bucket of this NicFlowLog.  # noqa: E501
        :type bucket: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NicFlowLog):
            return False
