...
class ActionProperties(object):
    ...
    def __init__(self, action_status=None, action_type=None, target_replica_count=None, local_vars_configuration=None):  # noqa: E501
    ...
    def target_replica_count(self):
        """Gets the target_replica_count of this ActionProperties.  # noqa: E501

        This action is considered successful when the associated autoscaling group reaches this replica count.  # noqa: E501

        :return: The target_replica_count of this ActionProperties.  # noqa: E501
        :rtype: int
        """
    ...
    def target_replica_count(self, target_replica_count):
        """Sets the target_replica_count of this ActionProperties.

        This action is considered successful when the associated autoscaling group reaches this replica count.  # noqa: E501

        :param target_replica_count: The target_replica_count of this ActionProperties.  # noqa: E501
        :type target_replica_count: int
        """
        if self.local_vars_configuration.client_side_validation and target_replica_count is None:  # noqa: E501
            raise ValueError("Invalid value for `target_replica_count`, must not be `None`")  # noqa: E501
