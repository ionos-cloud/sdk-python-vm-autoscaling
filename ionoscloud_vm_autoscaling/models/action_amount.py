...
class ActionAmount(object):
    ...
    allowable_values = [ABSOLUTE, PERCENTAGE]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ActionAmount - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActionAmount):
            return False
